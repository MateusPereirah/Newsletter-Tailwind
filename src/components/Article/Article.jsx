    ...
    return (
        <div className="p-5 bg-gray-200 dark:bg-dark-200 sm:rounded-xl sm:shadow-lg flex gap-2 flex-col items-center sm:hover:shadow-gray-500 sm:hover:dark:shadow-black sm:hover:shadow-lg">
            ...
            <div className="w-full flex flex-row justify-end gap-2 pr-5">
                {tags.map((tag) => <span key={tag} className="bg-alura-100 rounded-full px-4 py-1 text-gray-200 text-xs uppercase dark:bg-dark-100 font-bold hidden sm:flex hover:bg-alura-200 hover:scale-110">{tag}</span>)}
            </div>
